...
import com.jet.minhasfinancas.api.dto.AtualizaStatusDTO;
import com.jet.minhasfinancas.api.dto.LancamentoDTO;
...
import com.jet.minhasfinancas.service.LancamentoService;
...
public class LancamentoController {
	...
	public ResponseEntity buscar(
		...
		if(!usuario.isPresent()) {
			return ResponseEntity.badRequest().body("Não foi possível realizar a comsulta. Usuário não encontrado para o Id informado.");
		}else {
